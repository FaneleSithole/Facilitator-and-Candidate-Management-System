...
def cancel_button_event():
    subprocess.Popen(['python', 'facilitator/facilitatorAdd.py'])
    app.destroy()

cancel_button = CTkButton(master=app,
                        command=cancel_button_event,
                        text="Cancel",
                        text_color="#FFCC70",
                        corner_radius=32,
                        fg_color="transparent",
...
def cont_button_event():
    subprocess.Popen(['python', 'candidate/candidate3.py'])
    app.destroy()

continue_button = CTkButton(master=app,
                            command=cont_button_event,
                            text="Continue",
                            text_color="#FFCC70",
                            corner_radius=32,
                            fg_color="transparent",

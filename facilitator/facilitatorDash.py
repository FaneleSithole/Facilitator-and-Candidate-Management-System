...
def search_button_event():
    subprocess.Popen(['python', 'facilitator/facilitatorSearch.py'])
    app.destroy()
    print("Search button pressed")


def update_button_event():
    subprocess.Popen(['python', 'facilitator/facilitatorUpdate.py'])
    app.destroy()
...
def delete_button_event():
    subprocess.Popen(['python', 'facilitator/facilitatorDelete.py'])
    app.destroy()
    print("Delete button pressed")


def more_button_event():
    subprocess.Popen(['python', 'facilitator/facilitatorDash2.py'])
    app.destroy()
